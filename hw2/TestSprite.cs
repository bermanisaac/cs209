...
public class TestSprite
{
    ...
    public TestSprite(Sprite test, Sprite expected, uint testNumber, string testInventory, string expectedInventory) {
        this.test = test;
    ...
    public static void Main(string[] args)
    {
        ...
        TestSprite tester = new TestSprite(testSprite, expectedSprite, testNumber, args[7], args[15]);
